class LiteClientTest : public ::testing::Test {
 ...
 protected:
  ...
  std::shared_ptr<LiteClient> createLiteClient(InitialVersion initial_version = InitialVersion::kOn,
    ...
    app_engine_ = std::make_shared<NiceMock<AppEngineMock>>();
  ...
  std::shared_ptr<NiceMock<AppEngineMock>>& getAppEngine() { return app_engine_; }
 ...
 private:
  ...
  std::shared_ptr<NiceMock<AppEngineMock>> app_engine_;
